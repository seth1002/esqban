...
# PROP Scc_ProjName ""$/sqba/WavePipe/buffer", GXCAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD LINK32 /nologo /subsystem:console /machine:I386 /out:"../bin/Release/buffer.exe"
...
# ADD LINK32 /nologo /subsystem:console /debug /machine:I386 /out:"../bin/Debug/buffer.exe" /pdbtype:sept
