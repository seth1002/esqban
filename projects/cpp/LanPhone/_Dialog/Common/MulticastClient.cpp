// MulticastClient.cpp: implementation of the CMulticastClient class.
//
//////////////////////////////////////////////////////////////////////
...
CMulticastClient::CMulticastClient(int iSrcPort, int iDestPort, char *pszIP)
{
...
int CMulticastClient::Send(const char *buf, int size)
{
	TCHAR szError[100]={0};			// Error message string
